...
config = {'lock': threading.Lock(),
    ...
    '404': [ "Default.aspx","<title>404</title>", "<title>Error</title>", "<h3>TRACE</h3>", "This page can't be displayed", "HR noShade SIZE", "/error", "HTTP404", "404.aspx", "404 Not Found", "404.css", "404.png", "Your request is blocked"],  # 自定义404
